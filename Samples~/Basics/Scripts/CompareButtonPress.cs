...
{
    public class CompareButtonPress : MonoBehaviour, Injectable, Initializable, Cleanable
    {
        ...
        private void UpdateText()
        {
            ...
            _text.text = $"Compare Button Press: {_statisticsEntry.GetValue<int>()} {sign} {_compareValue}";
        }
    }
}
